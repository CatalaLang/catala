...
let build_cmd : int Cmd.t =
  ...
  let man = [
    ...
    "For \
     ...
     default $(b,_build)). If a file with a catala extension is used as target, this \
    ...
    `P
     ...
     the $(i,target-dir) (by default $(b,_target)).";
    `P "For instance, $(b,clerk \
