...
module type Spec = sig
  ...
  val build_object : Scan.item -> Nj.def Seq.t
  ...
  val linking_command :
    ...
    string ->
    string list
  (** Returns a list of arguments that represents a command to link all the
      files that were generated by the Ninja file. *)
  ...
  val run_artifact :
    ...
    string ->
    int * string list
  (** Runs the executable that was generated by the execution of the command
      [linking_command]. *)
end
