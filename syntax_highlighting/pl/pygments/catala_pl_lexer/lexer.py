...
class CatalaPlLexer(RegexLexer):
    ...
    tokens = {
        ...
        'code' : [
            ...
            (u'\\b(zakres|zalezy\\s+od|deklaracja|kolekcja|typu|opcjonalny|struktura|enumeracja|kontekst|zasada|pod\\s+warunkuem|czas|konsekwencja|spelnione|wynosi|asercja|definicja|etykieta|wyjatek)\\b', bygroups(Keyword.Declaration)),
            ...
            (u'\\b(calkowita|zerojedynkowy|czas|czas trwania|pieniadze|warunek|tekst|dziesietny|suma)\\b', bygroups(Keyword.Type)),
