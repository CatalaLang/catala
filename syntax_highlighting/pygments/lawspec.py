...
class LawspecLexer(RegexLexer):
    ...
    tokens = {
        ...
        #     (u'(\\*\\/)', bygroups(Generic.Prompt), '#pop'),
            ...
            (u'\\b(choix|\\s*\xe9tend|situation|donn\xe9e|optionnel|de|type|r\xe8gle|d\xe9fini|comme|fonction|param\xe8tres|renvoie|assertion|cons\xe9quence|condition|collection|constante)\\b', bygroups(Keyword.Declaration)),
