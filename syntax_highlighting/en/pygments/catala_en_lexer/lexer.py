...
class CustomLexer(RegexLexer):
    ...
    tokens = {
        ...
        'code' : [
            ...
            (u'\\b(match|with\\s+pattern|but\\s+replace|fixed|by|decreasing|increasing|varies|with|we\\s+have|let|in|scope|depends\\s+on|declaration|includes|content|type|rule|under\\s+condition|condition|data|consequence|fulfilled|equals|assertion|definition|state|label|exception|anything)\\b', bygroups(Keyword.Reserved)),
            ...
            (u'\\b(structure|enumeration|list\\s+of|optional\\s+of|integer|boolean|date|duration|money|text|decimal)\\b', bygroups(Keyword.Type)),
