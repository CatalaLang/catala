...
class CatalaEnLexer(RegexLexer):
    ...
    tokens = {
        ...
        'code' : [
            ...
            (u'\\b(application\\s+field|depends\\s+on|declaration|includes|collection|content|optional|structure|enumeration|context|rule|under\\s+condition|consequence|fulfilled|equals|assertion|definition)\\b', bygroups(Keyword.Declaration)),
