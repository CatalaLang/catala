...
class CustomLexer(RegexLexer):
    ...
    tokens = {
        ...
        'code' : [
            ...
            (u'\\b(contient|nombre|somme|tel\\s+que|existe|pour|tout|de|si|alors|sinon|est|liste\\s+vide|parmi|maximum|minimum|arrondi|combine|transforme\\s+chaque|en|initialement|trie|par\\s+ordre\\s+(dé)?croissant|puis|impossible)\\b', bygroups(Keyword.Declaration)),
