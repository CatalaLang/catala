...
syn match Statement contained "\<\(selon\|sous\s\+forme\|mais\s\+en\s\+remplaçant\|fixé\|par\|décroissant\|croissant\|varie\|avec\|on\s\+a\|soit\|dans\|tel\s\+que\|existe\|pour\|tout\|de\|initial\|parmi\|est\s+maximum\|est\s+minimum\|combinaison\|initialement\)\>"
