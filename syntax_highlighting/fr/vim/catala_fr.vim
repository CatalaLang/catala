...
syn match Keyword contained "\<\(contexte\|entrée\|résultat\|interne\|champ\s\+d'application\|liste\s\+de\|structure\|donnée\|énumération\|définition\|déclaration\|si\s\+et\s\+seulement\s\+si\|dépend\s\+de\|inclus\|contenu\|optionnel\|règle\|sous\s\+condition\|condition\|conséquence\|rempli\|égal\s\+à\|assertion\|état\|étiquette\|exception\|n'importe\s\+quel\|liste\s+vide\)\>"
syn match Statement contained "\<\(selon\|sous\s\+forme\|mais\s\+en\s\+remplaçant\|fixé\|par\|décroissant\|croissant\|varie\|avec\|on\s\+a\|soit\|dans\|tel\s\+que\|existe\|pour\|tout\|de\|initial\|parmi\|est\s+maximum\|est\s+minimum\|combine\|transforme\s+chaque\|en\|initialement\)\>"
