...
class CatalaNvLexer(RegexLexer):
    ...
    tokens = {
        ...
        'code': [
            ...
            (u'\\b(match|with|fixed|by|decreasing|increasing|varies|with\\s+param|we\\s+have|in|such\\s+that|exists|for|all|of|if|then|else|init)\\b', bygroups(Keyword.Reserved)),
            ...
            (u'\\b(int|bool|date|duration|money|text|decimal|number|sum)\\b',
