...
public class Period_internal {
    ...
    public static class Globals {
        ...
        /**
         * Splits the given period, returning one period per calendar month. The
         * first and last elements may be non-whole months. Edge-case: if the
         * given period is empty (begin >= end), an empty list is returned.
         */
        ...
        /**
         * Splits the given period, returning one period per year, split on the
         * first of the given month. The first and last elements returned may be
         * non-whole years.
         */
