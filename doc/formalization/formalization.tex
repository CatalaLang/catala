...
exception handling defined in \TirName{D-DefaultOneException} and
\TirName{D-DefaultExceptionsConflict}:
...
These two rules \TirName{C-Default} and \TirName{C-EmptyError} 
