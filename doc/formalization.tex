...
\inferrule[T-Scope]{
  ...
  \synlet\synvar{S}\;(\synvar{a_1}\syntyped\synunitt\synarrow\synvar{\tau_1})\;\cdots\;(\synvar{a_m}\syntyped\synunitt\synarrow\synvar{\tau_m})\synequal
  \synvar{e}[\synhole\mapsto\synlparen\synvar{a_1}\synellipsis\synvar{a_n}\synrparen]
}
\end{mathpar}
...
\redctx{\Delta'}
}. In the \TirName{T-Scope} rule, we isolate in the resulting \redctx{\Delta'} all the 
