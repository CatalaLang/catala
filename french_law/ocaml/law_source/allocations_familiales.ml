...
let embed_allocation_familiales_avril2008_in (_ : allocation_familiales_avril2008_in) :
    runtime_value =
  Unit
                 ...
                 log_decision_taken
                   {
                     ...
                     law_headings =
                       [
                         "Instruction interministérielle n°DSS/2B/2021/65 du 19 mars 2021 relative \
                          à la revalorisation au 1er avril 2021 des prestations familiales servies \
                          en métropole, en Guadeloupe, en Guyane, en Martinique, à la Réunion, à \
                          Saint-Barthélemy, à Saint-Martin et dans le département de Mayotte";
                     ...
                     law_headings =
                       [
                         "Instruction interministérielle no DSS/SD2B/2020/33 du 18 février 2020 \
                          ...
                          Martinique, à La Réunion, à Saint-Barthélemy, à Saint-Martin et dans le \
                 ...
                 log_decision_taken
                   {
                     ...
                     law_headings =
                       [
                         "Instruction ministérielle N°DSS/SD2B/2019/65 du 25 mars 2019 relative à \
                          la revalorisation au 1er avril 2019 des prestations familiales servies \
                          en métropole";
                         "Montant de la base mensuelle des allocations familiales";
                         "Décrets divers";
                       ];
...
let allocations_familiales (allocations_familiales_in : allocations_familiales_in) =
                 ...
                 log_decision_taken
                   {
                     ...
                     law_headings =
                       [
                         "Article 1";
                         "Arrêté du 14 décembre 2020 relatif au montant des plafonds de ressources \
                          de certaines prestations familiales et aux tranches du barème applicable \
                     ...
                     law_headings =
                       [
                         "Instruction interministerielle no DSS/SD2B/2019/261 du 18 décembre 2019 \
                          ...
                          ressources d’attribution de certaines prestations familiales servies en \
                          métropole, en Guadeloupe, en Guyane, en Martinique, à La Réunion, à \
  ...
  let montant_initial_base_quatrieme_enfant_et_plus_mayotte_ : money =
    log_variable_definition
      ...
      (try
         if
           array_length enfants_a_charge_droit_ouvert_prestation_familiale_ >! integer_of_string "3"
         then
                   ...
                   log_decision_taken
                     ...
                     && param_.age
                        >=! log_end_call
                              ...
                              (log_variable_definition
                                 [
                                   "AllocationsFamiliales"; "âge_minimum_alinéa_1_l521_3"; "output";
                                 ]
                                 unembeddable
                                 (log_begin_call
                                    [ "AllocationsFamiliales"; "âge_minimum_alinéa_1_l521_3" ]
           ...
           (fun (enfant_ : _) ->
             {
               ...
               obligation_scolaire =
                 (if enfant_.d_date_de_naissance +@ duration_of_numbers 3 0 0 >=@ i_date_courante_
                 then Avant ()
                 else if
