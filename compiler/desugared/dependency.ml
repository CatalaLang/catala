(* This file is part of the Catala compiler, a specification language for tax
   ...
   Nicolas Chataing <nicolas.chataing@ens.fr> Licensed under the Apache License,
...
module ScopeDependenciesJSON =
  Catala_utils.Graphs.JSON_Graph (Vertex) (ScopeDependencies)

let scope_dependencies_to_json = ScopeDependenciesJSON.graph_to_json
