...
(rule (alias man) (action (with-stdout-to catala-markdown.1 (run %{bin:catala} markdown --help=groff))))
(rule (alias man) (action (with-stdout-to catala-ocaml.1 (run %{bin:catala} ocaml --help=groff))))
(rule (alias man) (action (with-stdout-to catala-pdf.1 (run %{bin:catala} pdf --help=groff))))
