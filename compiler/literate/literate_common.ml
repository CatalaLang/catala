...
let literal_source_files = function
  ...
  | It -> "File sorgente in questo documento"
...
let literal_disclaimer_and_link = function
  ...
  | Pl ->
    "Niniejszy dokument został opracowany na podstawie zestawu plików \
     ...
     [https://catala-lang.org](https://catala-lang.org)"
  | It ->
    "Questo documento è stato prodotto a partire da un insieme di file \
     sorgente scritti nel linguaggio di programmazione Catala, che unisce il \
     testo legislativo e il codice informatico che lo traduce. Per ulteriori \
     informazioni sulla metodologia e su come leggere il codice, visitare il \
     sito [https://catala-lang.org](https://catala-lang.org)."
