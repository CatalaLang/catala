...
let literal_source_files = function
  ...
  | `Es -> "Archivos fuente incluidos en este documento"
...
let literal_disclaimer_and_link = function
  ...
  | `Pl ->
    "Niniejszy dokument został opracowany na podstawie zestawu plików \
     ...
     [https://catala-lang.org](https://catala-lang.org)"
  | `Es ->
    "Este documento se ha generado a partir de archivos fuente escritos en el \
     lenguaje de programación Catala, que combinan el texto legislativo y el \
     código informático que lo traduce. Para más información, visite \
     [https://catala-lang.org](https://catala-lang.org)."
