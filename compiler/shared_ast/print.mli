...
module UserFacing : sig
  val unit : Global.backend_lang -> Format.formatter -> Catala_runtime.unit -> unit
  val bool : Global.backend_lang -> Format.formatter -> Catala_runtime.bool -> unit
  ...
  val money : Global.backend_lang -> Format.formatter -> Catala_runtime.money -> unit
  val date : Global.backend_lang -> Format.formatter -> Catala_runtime.date -> unit
