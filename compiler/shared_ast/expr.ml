...
let shallow_fold
  ...
  match Mark.remove e with
  | ELit _ | EVar _ | EFatalError _ | EPos _ | EExternal _ | ELocation _ | EEmpty -> acc
...
and equal : type a. (a, 't) gexpr -> (a, 't) gexpr -> bool =
 fun e1 e2 ->
  ...
  | ( ( EVar _ | EExternal _ | ETuple _ | ETupleAccess _ | EArray _ | ELit _
      | EAbs _ | EApp _ | EAppOp _ | EAssert _ | EFatalError _ | EPos _ | EDefault _
...
let make_pos p m0 =
  epos p (with_ty m0 ~pos:p (TLit TPos, p))
