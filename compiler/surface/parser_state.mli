...
val new_heading : string * string option * bool * int -> Lexing.position * Lexing.position -> Ast.law_heading

val get_current_heading : unit -> string list

val push_attribute : Pos.attr -> unit

val pop_attributes : unit -> Pos.attr list
