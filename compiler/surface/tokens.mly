...
%token BEGIN_DIRECTIVE END_DIRECTIVE LAW_INCLUDE MODULE_DEF MODULE_USE MODULE_ALIAS EXTERNAL LINESKIP
%token<int> AT_PAGE
...
%token COMBINE MAP_EACH MAXIMUM MINIMUM SORT ORDER_ASCENDING ORDER_DESCENDING AND_THEN IS OR_IF_LIST_EMPTY BUT_REPLACE
