...
class virtual ['self] program_map : object ('self)
  ...
  method visit_law_article_item :
    'monomorphic. 'env -> law_article_item -> law_article_item
...
class virtual ['self] program_iter : object ('self)
  ...
  method visit_scope_decl_context_data :
    'monomorphic. 'env -> scope_decl_context_data -> unit
  method visit_scope_decl_context_item :
    'monomorphic. 'env -> scope_decl_context_item -> unit
  method visit_scope_decl_context_scope :
