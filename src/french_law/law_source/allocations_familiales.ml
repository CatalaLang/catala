                   ...
                   (fun (_ : _) ->
                     ...
                     Array.fold_left
                         ...
                         if predicate_ acc_ >! predicate_ item_ then acc_ else item_)
                       {
                         ...
                         remuneration_mensuelle = money_of_cent_string "0";
             ...
             [|
               (fun (_ : _) ->
                 handle_default [||]
                   (fun (_ : _) -> true)
                   (fun (_ : _) ->
                     int_to_rat (array_length enfants_a_charge_droit_ouvert_prestation_familiale_)));
             |]
             (fun (_ : _) -> false)
             (fun (_ : _) -> raise EmptyError)))
  in
                   ...
                   (fun (_ : _) ->
                     if droit_ouvert_base_ then
                       Array.fold_left
                         ...
                         (money_of_cent_string "0") enfants_a_charge_
                     else money_of_cent_string "0"));
             |]
             (fun (_ : _) -> false)
             (fun (_ : _) -> raise EmptyError)))
